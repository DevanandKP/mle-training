...
def parse_args():
    ...
    parser.add_argument("--datapath", help="path to the datasets ", type=str, default="data/processed")
    parser.add_argument("--modelpath", help="path to the model files ", type=str, default="artifacts")
